    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(1))+1px)]"
      ...
      >
        <div
          ...
          className="cursor-default h-full p-2 w-full group-data-[collapsible=icon]:p-2 relative"
        >
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-transparent relative flex flex-1 flex-col",
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/50 ring-sidebar-ring flex h-6 shrink-0 items-center rounded-md pl-4 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuSkeleton({
  ...
  return (
    ...
    >
      ...
      <div
        className="h-4 max-w-(--skeleton-width) flex-1 animate-pulse bg-muted rounded-md"
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      className={cn("relative pl-3 flex items-center ", className)}
      {...props}
    >
      {/* Vertical line */}
      {showLine && (
        ...
        >
          ...
          <div
            style={{
              ...
              background: active ? "#93c5fd" : "#f1f5f9",
            }}
          />
